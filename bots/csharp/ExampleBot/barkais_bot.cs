		...
		public void DoTurn(IPirateGame game)
		{
			try
			{
				...
				if (kamikaze)
				{
					...
					{
						ts[0] = new Treasure(19, new Location(23, 31));
						ts[1] = new Treasure(20, new Location(24, 30));
                        ts[2] = new Treasure(20, new Location(25, 29));
                        ts[3] = new Treasure(20, new Location(26, 28));
					}
					else
					{
						ts[0] = new Treasure(19, new Location(23, 1));
						ts[1] = new Treasure(20, new Location(24, 2));
                        ts[2] = new Treasure(20, new Location(25, 3));
                        ts[3] = new Treasure(20, new Location(26, 4));
					}
                    ds[0] = 0;
                    ds[1] = 0;
                    ds[2] = 0;
